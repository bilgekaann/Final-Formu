...
namespace OkulProje
{
    public partial class DersPaneli : Form
    {
        ...
        void listele()
        {
            dataGridView1.DataSource = (from x in db.pru_ders
                                        select new
                                        {
                                            x.ders_id,
                                            x.ders_ad,
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sor == DialogResult.Yes)
            {
                ...
                var dersbul = db.pru_ders.Find(DersID);
                db.pru_ders.Remove(dersbul);
                db.SaveChanges();
        ...
        private void btnguncelle_Click(object sender, EventArgs e)
        {
            ...
            var guncelle = db.pru_ders.Find(DersID);
