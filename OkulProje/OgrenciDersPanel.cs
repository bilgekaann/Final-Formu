...
namespace OkulProje
{
    public partial class OgrenciDersPanel : Form
    {
        ...
        void listele()
        {
            dataGridView1.DataSource = (from x in db.pru_ogrenciders
                                        select new
                                        {
                                            x.ogrenciders_id,
                                            x.pru_ders.ders_ad,
                                            x.pru_ogrenci.ogrenci_fullname
            ...
            var derslist = db.pru_ders.ToList();
        ...
        {
            listele();
            var ogrenciler = (from x in db.pru_ogrenci
                               select new
                               {
                                   x.ogrenci_id,
                                   x.ogrenci_fullname
            ...
            var dersler = (from x in db.pru_ders
                              select new
                              {
                                  x.ders_id,
                                  x.ders_ad
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sor == DialogResult.Yes)
            {
                ...
                var ogrencidersbul = db.pru_ogrenciders.Find(ogrencidersID);
                db.pru_ogrenciders.Remove(ogrencidersbul);
                db.SaveChanges();
        ...
        {
            pru_ogrenciders ekle = new pru_ogrenciders();
            ...
            {
                {
                    ...
                    var sonuc = (from x in db.pru_ogrenciders
                                 where x.pru_ogrenci.ogrenci_fullname.Contains(arama)
                                 select new
                                 {
                                     x.ogrenciders_id,
                                     x.pru_ders.ders_ad,
